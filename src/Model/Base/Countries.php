...
abstract class Countries implements ActiveRecordInterface
{
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[CountriesTableMap::COL_CODE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CountriesTableMap::COL_NAME] = true;
        }
    ...
    public function setContinent($v)
    {
        ...
        if ($this->continent !== $v) {
            $this->continent = $v;
            $this->modifiedColumns[CountriesTableMap::COL_CONTINENT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CountriesTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CountriesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CountriesTableMap::translateFieldName('Continent', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CountriesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CountriesTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(CountriesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(CountriesTableMap::COL_CONTINENT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CountriesTableMap::COL_CODE)) {
            $criteria->add(CountriesTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(CountriesTableMap::COL_NAME)) {
            $criteria->add(CountriesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(CountriesTableMap::COL_CONTINENT)) {
            $criteria->add(CountriesTableMap::COL_CONTINENT, $this->continent);
        }
