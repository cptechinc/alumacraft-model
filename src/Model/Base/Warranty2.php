...
/**
 * Base class that represents a row from the 'WARRANTY2' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Warranty2 implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\Warranty2TableMap';
    ...
    /**
     * Initializes internal state of Base\Warranty2 object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Warranty2</code> instance.  If
     * <code>obj</code> is an instance of <code>Warranty2</code>, delegates to
     * <code>equals(Warranty2)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Warranty2 The current object, for fluid interface
     */
     ...
     * @return $this|\Warranty2 The current object (for fluent API support)
     */
    public function setWarmseq($v)
    {
        ...
        if ($this->warmseq !== $v) {
            $this->warmseq = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMSEQ] = true;
        }
    ...
    public function setInititemnbr($v)
    {
        ...
        if ($this->inititemnbr !== $v) {
            $this->inititemnbr = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_INITITEMNBR] = true;
        }
    ...
    public function setSermsernbr($v)
    {
        ...
        if ($this->sermsernbr !== $v) {
            $this->sermsernbr = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_SERMSERNBR] = true;
        }
    ...
    public function setWarmsaledate($v)
    {
        ...
        if ($this->warmsaledate !== $v) {
            $this->warmsaledate = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMSALEDATE] = true;
        }
    ...
    public function setWarmownfname($v)
    {
        ...
        if ($this->warmownfname !== $v) {
            $this->warmownfname = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNFNAME] = true;
        }
    ...
    public function setWarmownmname($v)
    {
        ...
        if ($this->warmownmname !== $v) {
            $this->warmownmname = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNMNAME] = true;
        }
    ...
    public function setWarmownlname($v)
    {
        ...
        if ($this->warmownlname !== $v) {
            $this->warmownlname = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNLNAME] = true;
        }
    ...
    public function setWarmownadr1($v)
    {
        ...
        if ($this->warmownadr1 !== $v) {
            $this->warmownadr1 = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNADR1] = true;
        }
    ...
    public function setWarmownadr2($v)
    {
        ...
        if ($this->warmownadr2 !== $v) {
            $this->warmownadr2 = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNADR2] = true;
        }
    ...
    public function setWarmownadr3($v)
    {
        ...
        if ($this->warmownadr3 !== $v) {
            $this->warmownadr3 = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNADR3] = true;
        }
    ...
    public function setWarmowncity($v)
    {
        ...
        if ($this->warmowncity !== $v) {
            $this->warmowncity = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNCITY] = true;
        }
    ...
    public function setWarmownstat($v)
    {
        ...
        if ($this->warmownstat !== $v) {
            $this->warmownstat = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNSTAT] = true;
        }
    ...
    public function setWarmownzip($v)
    {
        ...
        if ($this->warmownzip !== $v) {
            $this->warmownzip = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMOWNZIP] = true;
        }
    ...
    public function setWarmsordnbr($v)
    {
        ...
        if ($this->warmsordnbr !== $v) {
            $this->warmsordnbr = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMSORDNBR] = true;
        }
    ...
    public function setWarminvcdate($v)
    {
        ...
        if ($this->warminvcdate !== $v) {
            $this->warminvcdate = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMINVCDATE] = true;
        }
    ...
    public function setWarmcustid($v)
    {
        ...
        if ($this->warmcustid !== $v) {
            $this->warmcustid = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMCUSTID] = true;
        }
    ...
    public function setWarmspid($v)
    {
        ...
        if ($this->warmspid !== $v) {
            $this->warmspid = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMSPID] = true;
        }
    ...
    public function setWarmentrydate($v)
    {
        ...
        if ($this->warmentrydate !== $v) {
            ...
            $this->modifiedColumns[Warranty2TableMap::COL_WARMENTRYDATE] = true;
        }
    ...
    public function setRegistermotor($v)
    {
        ...
        if ($this->registermotor !== $v) {
            ...
            $this->modifiedColumns[Warranty2TableMap::COL_REGISTERMOTOR] = true;
        }
    ...
    public function setWarmengsernbr($v)
    {
        ...
        if ($this->warmengsernbr !== $v) {
            ...
            $this->modifiedColumns[Warranty2TableMap::COL_WARMENGSERNBR] = true;
        }
    ...
    public function setWarmenghorse($v)
    {
        ...
        if ($this->warmenghorse !== $v) {
            $this->warmenghorse = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMENGHORSE] = true;
        }
    ...
    public function setWarmengmodelyear($v)
    {
        ...
        if ($this->warmengmodelyear !== $v) {
            ...
            $this->modifiedColumns[Warranty2TableMap::COL_WARMENGMODELYEAR] = true;
        }
    ...
    public function setWarmengdesc($v)
    {
        ...
        if ($this->warmengdesc !== $v) {
            $this->warmengdesc = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMENGDESC] = true;
        }
    ...
    public function setWarmphone1($v)
    {
        ...
        if ($this->warmphone1 !== $v) {
            $this->warmphone1 = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMPHONE1] = true;
        }
    ...
    public function setWarmphone2($v)
    {
        ...
        if ($this->warmphone2 !== $v) {
            $this->warmphone2 = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMPHONE2] = true;
        }
    ...
    public function setWarmemail($v)
    {
        ...
        if ($this->warmemail !== $v) {
            $this->warmemail = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMEMAIL] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setWarmdelvdate($v)
    {
        ...
        if ($this->warmdelvdate !== $v) {
            $this->warmdelvdate = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_WARMDELVDATE] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[Warranty2TableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : Warranty2TableMap::translateFieldName('Warmseq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmseq = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : Warranty2TableMap::translateFieldName('Inititemnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inititemnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : Warranty2TableMap::translateFieldName('Sermsernbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sermsernbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : Warranty2TableMap::translateFieldName('Warmsaledate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmsaledate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : Warranty2TableMap::translateFieldName('Warmownfname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownfname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : Warranty2TableMap::translateFieldName('Warmownmname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownmname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : Warranty2TableMap::translateFieldName('Warmownlname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownlname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : Warranty2TableMap::translateFieldName('Warmownadr1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownadr1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : Warranty2TableMap::translateFieldName('Warmownadr2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownadr2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : Warranty2TableMap::translateFieldName('Warmownadr3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownadr3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : Warranty2TableMap::translateFieldName('Warmowncity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmowncity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : Warranty2TableMap::translateFieldName('Warmownstat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownstat = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : Warranty2TableMap::translateFieldName('Warmownzip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmownzip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : Warranty2TableMap::translateFieldName('Warmsordnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmsordnbr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : Warranty2TableMap::translateFieldName('Warminvcdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warminvcdate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : Warranty2TableMap::translateFieldName('Warmcustid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmcustid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : Warranty2TableMap::translateFieldName('Warmspid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmspid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : Warranty2TableMap::translateFieldName('Warmentrydate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmentrydate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : Warranty2TableMap::translateFieldName('Registermotor', TableMap::TYPE_PHPNAME, $indexType)];
            $this->registermotor = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : Warranty2TableMap::translateFieldName('Warmengsernbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmengsernbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : Warranty2TableMap::translateFieldName('Warmenghorse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmenghorse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : Warranty2TableMap::translateFieldName('Warmengmodelyear', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmengmodelyear = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : Warranty2TableMap::translateFieldName('Warmengdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmengdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : Warranty2TableMap::translateFieldName('Warmphone1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmphone1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : Warranty2TableMap::translateFieldName('Warmphone2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmphone2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : Warranty2TableMap::translateFieldName('Warmemail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmemail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : Warranty2TableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : Warranty2TableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : Warranty2TableMap::translateFieldName('Warmdelvdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warmdelvdate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : Warranty2TableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 30; // 30 = Warranty2TableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Warranty2'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWarranty2Query::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Warranty2::setDeleted()
     * @see Warranty2::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWarranty2Query::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                Warranty2TableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSEQ)) {
            $modifiedColumns[':p' . $index++]  = 'WarmSeq';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_INITITEMNBR)) {
            $modifiedColumns[':p' . $index++]  = 'InitItemNbr';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_SERMSERNBR)) {
            $modifiedColumns[':p' . $index++]  = 'SermSerNbr';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSALEDATE)) {
            $modifiedColumns[':p' . $index++]  = 'WarmSaleDate';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNFNAME)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnFname';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNMNAME)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnMname';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNLNAME)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnLname';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNADR1)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnAdr1';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNADR2)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnAdr2';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNADR3)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnAdr3';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNCITY)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnCity';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNSTAT)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnStat';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNZIP)) {
            $modifiedColumns[':p' . $index++]  = 'WarmOwnZip';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSORDNBR)) {
            $modifiedColumns[':p' . $index++]  = 'WarmSordNbr';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMINVCDATE)) {
            $modifiedColumns[':p' . $index++]  = 'WarmInvcDate';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMCUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'WarmCustId';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSPID)) {
            $modifiedColumns[':p' . $index++]  = 'WarmSpId';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENTRYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'WarmEntryDate';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_REGISTERMOTOR)) {
            $modifiedColumns[':p' . $index++]  = 'RegisterMotor';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGSERNBR)) {
            $modifiedColumns[':p' . $index++]  = 'WarmEngSerNbr';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGHORSE)) {
            $modifiedColumns[':p' . $index++]  = 'WarmEngHorse';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGMODELYEAR)) {
            $modifiedColumns[':p' . $index++]  = 'WarmEngModelYear';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGDESC)) {
            $modifiedColumns[':p' . $index++]  = 'WarmEngDesc';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMPHONE1)) {
            $modifiedColumns[':p' . $index++]  = 'WarmPhone1';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMPHONE2)) {
            $modifiedColumns[':p' . $index++]  = 'WarmPhone2';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMEMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'WarmEmail';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMDELVDATE)) {
            $modifiedColumns[':p' . $index++]  = 'WarmDelvDate';
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'Dummy';
        }

        $sql = sprintf(
            'INSERT INTO WARRANTY2 (%s) VALUES (%s)',
    ...
    {
        $pos = Warranty2TableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Warranty2'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Warranty2'][$this->hashCode()] = true;
        $keys = Warranty2TableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSEQ)) {
            $criteria->add(Warranty2TableMap::COL_WARMSEQ, $this->warmseq);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_INITITEMNBR)) {
            $criteria->add(Warranty2TableMap::COL_INITITEMNBR, $this->inititemnbr);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_SERMSERNBR)) {
            $criteria->add(Warranty2TableMap::COL_SERMSERNBR, $this->sermsernbr);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSALEDATE)) {
            $criteria->add(Warranty2TableMap::COL_WARMSALEDATE, $this->warmsaledate);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNFNAME)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNFNAME, $this->warmownfname);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNMNAME)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNMNAME, $this->warmownmname);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNLNAME)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNLNAME, $this->warmownlname);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNADR1)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNADR1, $this->warmownadr1);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNADR2)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNADR2, $this->warmownadr2);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNADR3)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNADR3, $this->warmownadr3);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNCITY)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNCITY, $this->warmowncity);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNSTAT)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNSTAT, $this->warmownstat);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMOWNZIP)) {
            $criteria->add(Warranty2TableMap::COL_WARMOWNZIP, $this->warmownzip);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSORDNBR)) {
            $criteria->add(Warranty2TableMap::COL_WARMSORDNBR, $this->warmsordnbr);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMINVCDATE)) {
            $criteria->add(Warranty2TableMap::COL_WARMINVCDATE, $this->warminvcdate);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMCUSTID)) {
            $criteria->add(Warranty2TableMap::COL_WARMCUSTID, $this->warmcustid);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMSPID)) {
            $criteria->add(Warranty2TableMap::COL_WARMSPID, $this->warmspid);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENTRYDATE)) {
            $criteria->add(Warranty2TableMap::COL_WARMENTRYDATE, $this->warmentrydate);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_REGISTERMOTOR)) {
            $criteria->add(Warranty2TableMap::COL_REGISTERMOTOR, $this->registermotor);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGSERNBR)) {
            $criteria->add(Warranty2TableMap::COL_WARMENGSERNBR, $this->warmengsernbr);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGHORSE)) {
            $criteria->add(Warranty2TableMap::COL_WARMENGHORSE, $this->warmenghorse);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGMODELYEAR)) {
            $criteria->add(Warranty2TableMap::COL_WARMENGMODELYEAR, $this->warmengmodelyear);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMENGDESC)) {
            $criteria->add(Warranty2TableMap::COL_WARMENGDESC, $this->warmengdesc);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMPHONE1)) {
            $criteria->add(Warranty2TableMap::COL_WARMPHONE1, $this->warmphone1);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMPHONE2)) {
            $criteria->add(Warranty2TableMap::COL_WARMPHONE2, $this->warmphone2);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMEMAIL)) {
            $criteria->add(Warranty2TableMap::COL_WARMEMAIL, $this->warmemail);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_DATEUPDTD)) {
            $criteria->add(Warranty2TableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_TIMEUPDTD)) {
            $criteria->add(Warranty2TableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_WARMDELVDATE)) {
            $criteria->add(Warranty2TableMap::COL_WARMDELVDATE, $this->warmdelvdate);
        }
        if ($this->isColumnModified(Warranty2TableMap::COL_DUMMY)) {
            $criteria->add(Warranty2TableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildWarranty2Query::create();
        $criteria->add(Warranty2TableMap::COL_WARMSEQ, $this->warmseq);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Warranty2 (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Warranty2 Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(Warranty2TableMap::DEFAULT_STRING_FORMAT);
    }
