 ...
 */
abstract class ArSaleper1 implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ArSaleper1TableMap';
    ...
    /**
     * Initializes internal state of Base\ArSaleper1 object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ArSaleper1</code> instance.  If
     * <code>obj</code> is an instance of <code>ArSaleper1</code>, delegates to
     * <code>equals(ArSaleper1)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ArSaleper1 The current object, for fluid interface
     */
     ...
     * @return $this|\ArSaleper1 The current object (for fluent API support)
     */
    public function setArspsaleper1($v)
    {
        ...
        if ($this->arspsaleper1 !== $v) {
            $this->arspsaleper1 = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPSALEPER1] = true;
        }
    ...
    public function setArspname($v)
    {
        ...
        if ($this->arspname !== $v) {
            $this->arspname = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPNAME] = true;
        }
    ...
    public function setArspmtdsale($v)
    {
        ...
        if ($this->arspmtdsale !== $v) {
            $this->arspmtdsale = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPMTDSALE] = true;
        }
    ...
    public function setArspytdsale($v)
    {
        ...
        if ($this->arspytdsale !== $v) {
            $this->arspytdsale = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPYTDSALE] = true;
        }
    ...
    public function setArspltdsale($v)
    {
        ...
        if ($this->arspltdsale !== $v) {
            $this->arspltdsale = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPLTDSALE] = true;
        }
    ...
    public function setArsplastsaledate($v)
    {
        ...
        if ($this->arsplastsaledate !== $v) {
            ...
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPLASTSALEDATE] = true;
        }
    ...
    public function setArspmtdcommearn($v)
    {
        ...
        if ($this->arspmtdcommearn !== $v) {
            ...
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPMTDCOMMEARN] = true;
        }
    ...
    public function setArspytdcommearn($v)
    {
        ...
        if ($this->arspytdcommearn !== $v) {
            ...
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPYTDCOMMEARN] = true;
        }
    ...
    public function setArspltdcommearn($v)
    {
        ...
        if ($this->arspltdcommearn !== $v) {
            ...
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPLTDCOMMEARN] = true;
        }
    ...
    public function setArspmtdcommpaid($v)
    {
        ...
        if ($this->arspmtdcommpaid !== $v) {
            ...
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPMTDCOMMPAID] = true;
        }
    ...
    public function setArspytdcommpaid($v)
    {
        ...
        if ($this->arspytdcommpaid !== $v) {
            ...
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPYTDCOMMPAID] = true;
        }
    ...
    public function setArspltdcommpaid($v)
    {
        ...
        if ($this->arspltdcommpaid !== $v) {
            ...
            $this->modifiedColumns[ArSaleper1TableMap::COL_ARSPLTDCOMMPAID] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[ArSaleper1TableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArSaleper1TableMap::translateFieldName('Arspsaleper1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspsaleper1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArSaleper1TableMap::translateFieldName('Arspname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArSaleper1TableMap::translateFieldName('Arspmtdsale', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspmtdsale = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArSaleper1TableMap::translateFieldName('Arspytdsale', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspytdsale = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArSaleper1TableMap::translateFieldName('Arspltdsale', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspltdsale = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ArSaleper1TableMap::translateFieldName('Arsplastsaledate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arsplastsaledate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ArSaleper1TableMap::translateFieldName('Arspmtdcommearn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspmtdcommearn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ArSaleper1TableMap::translateFieldName('Arspytdcommearn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspytdcommearn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ArSaleper1TableMap::translateFieldName('Arspltdcommearn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspltdcommearn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ArSaleper1TableMap::translateFieldName('Arspmtdcommpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspmtdcommpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ArSaleper1TableMap::translateFieldName('Arspytdcommpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspytdcommpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ArSaleper1TableMap::translateFieldName('Arspltdcommpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspltdcommpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ArSaleper1TableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ArSaleper1TableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ArSaleper1TableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 15; // 15 = ArSaleper1TableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ArSaleper1'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildArSaleper1Query::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ArSaleper1::setDeleted()
     * @see ArSaleper1::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildArSaleper1Query::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArSaleper1TableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPSALEPER1)) {
            $modifiedColumns[':p' . $index++]  = 'ArspSalePer1';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPNAME)) {
            $modifiedColumns[':p' . $index++]  = 'ArspName';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPMTDSALE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspMtdSale';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPYTDSALE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspYtdSale';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLTDSALE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLtdSale';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLASTSALEDATE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLastSaleDate';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPMTDCOMMEARN)) {
            $modifiedColumns[':p' . $index++]  = 'ArspMtdCommEarn';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPYTDCOMMEARN)) {
            $modifiedColumns[':p' . $index++]  = 'ArspYtdCommEarn';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLTDCOMMEARN)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLtdCommEarn';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPMTDCOMMPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArspMtdCommPaid';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPYTDCOMMPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArspYtdCommPaid';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLTDCOMMPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLtdCommPaid';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_DUMMY)) {
    ...
    {
        $pos = ArSaleper1TableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['ArSaleper1'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArSaleper1'][$this->hashCode()] = true;
        $keys = ArSaleper1TableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPSALEPER1)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPSALEPER1, $this->arspsaleper1);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPNAME)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPNAME, $this->arspname);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPMTDSALE)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPMTDSALE, $this->arspmtdsale);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPYTDSALE)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPYTDSALE, $this->arspytdsale);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLTDSALE)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPLTDSALE, $this->arspltdsale);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLASTSALEDATE)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPLASTSALEDATE, $this->arsplastsaledate);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPMTDCOMMEARN)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPMTDCOMMEARN, $this->arspmtdcommearn);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPYTDCOMMEARN)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPYTDCOMMEARN, $this->arspytdcommearn);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLTDCOMMEARN)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPLTDCOMMEARN, $this->arspltdcommearn);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPMTDCOMMPAID)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPMTDCOMMPAID, $this->arspmtdcommpaid);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPYTDCOMMPAID)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPYTDCOMMPAID, $this->arspytdcommpaid);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_ARSPLTDCOMMPAID)) {
            $criteria->add(ArSaleper1TableMap::COL_ARSPLTDCOMMPAID, $this->arspltdcommpaid);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_DATEUPDTD)) {
            $criteria->add(ArSaleper1TableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_TIMEUPDTD)) {
            $criteria->add(ArSaleper1TableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(ArSaleper1TableMap::COL_DUMMY)) {
            $criteria->add(ArSaleper1TableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildArSaleper1Query::create();
        $criteria->add(ArSaleper1TableMap::COL_ARSPSALEPER1, $this->arspsaleper1);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArSaleper1 (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArSaleper1 Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ArSaleper1TableMap::DEFAULT_STRING_FORMAT);
    }
