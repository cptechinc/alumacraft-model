...
/**
 * Base class that represents a row from the 'AR_SALEPER3' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ArSaleper3 implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ArSaleper3TableMap';
    ...
    /**
     * Initializes internal state of Base\ArSaleper3 object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ArSaleper3</code> instance.  If
     * <code>obj</code> is an instance of <code>ArSaleper3</code>, delegates to
     * <code>equals(ArSaleper3)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ArSaleper3 The current object, for fluid interface
     */
     ...
     * @return $this|\ArSaleper3 The current object (for fluent API support)
     */
    public function setArspsaleper3($v)
    {
        ...
        if ($this->arspsaleper3 !== $v) {
            $this->arspsaleper3 = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPSALEPER3] = true;
        }
    ...
    public function setArspname($v)
    {
        ...
        if ($this->arspname !== $v) {
            $this->arspname = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPNAME] = true;
        }
    ...
    public function setArspmtdsale($v)
    {
        ...
        if ($this->arspmtdsale !== $v) {
            $this->arspmtdsale = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPMTDSALE] = true;
        }
    ...
    public function setArspytdsale($v)
    {
        ...
        if ($this->arspytdsale !== $v) {
            $this->arspytdsale = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPYTDSALE] = true;
        }
    ...
    public function setArspltdsale($v)
    {
        ...
        if ($this->arspltdsale !== $v) {
            $this->arspltdsale = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPLTDSALE] = true;
        }
    ...
    public function setArsplastsaledate($v)
    {
        ...
        if ($this->arsplastsaledate !== $v) {
            ...
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPLASTSALEDATE] = true;
        }
    ...
    public function setArspmtdcommearn($v)
    {
        ...
        if ($this->arspmtdcommearn !== $v) {
            ...
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPMTDCOMMEARN] = true;
        }
    ...
    public function setArspytdcommearn($v)
    {
        ...
        if ($this->arspytdcommearn !== $v) {
            ...
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPYTDCOMMEARN] = true;
        }
    ...
    public function setArspltdcommearn($v)
    {
        ...
        if ($this->arspltdcommearn !== $v) {
            ...
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPLTDCOMMEARN] = true;
        }
    ...
    public function setArspmtdcommpaid($v)
    {
        ...
        if ($this->arspmtdcommpaid !== $v) {
            ...
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPMTDCOMMPAID] = true;
        }
    ...
    public function setArspytdcommpaid($v)
    {
        ...
        if ($this->arspytdcommpaid !== $v) {
            ...
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPYTDCOMMPAID] = true;
        }
    ...
    public function setArspltdcommpaid($v)
    {
        ...
        if ($this->arspltdcommpaid !== $v) {
            ...
            $this->modifiedColumns[ArSaleper3TableMap::COL_ARSPLTDCOMMPAID] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[ArSaleper3TableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArSaleper3TableMap::translateFieldName('Arspsaleper3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspsaleper3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArSaleper3TableMap::translateFieldName('Arspname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArSaleper3TableMap::translateFieldName('Arspmtdsale', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspmtdsale = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArSaleper3TableMap::translateFieldName('Arspytdsale', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspytdsale = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArSaleper3TableMap::translateFieldName('Arspltdsale', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspltdsale = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ArSaleper3TableMap::translateFieldName('Arsplastsaledate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arsplastsaledate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ArSaleper3TableMap::translateFieldName('Arspmtdcommearn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspmtdcommearn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ArSaleper3TableMap::translateFieldName('Arspytdcommearn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspytdcommearn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ArSaleper3TableMap::translateFieldName('Arspltdcommearn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspltdcommearn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ArSaleper3TableMap::translateFieldName('Arspmtdcommpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspmtdcommpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ArSaleper3TableMap::translateFieldName('Arspytdcommpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspytdcommpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ArSaleper3TableMap::translateFieldName('Arspltdcommpaid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arspltdcommpaid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ArSaleper3TableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ArSaleper3TableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ArSaleper3TableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 15; // 15 = ArSaleper3TableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ArSaleper3'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildArSaleper3Query::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ArSaleper3::setDeleted()
     * @see ArSaleper3::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildArSaleper3Query::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArSaleper3TableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPSALEPER3)) {
            $modifiedColumns[':p' . $index++]  = 'ArspSalePer3';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPNAME)) {
            $modifiedColumns[':p' . $index++]  = 'ArspName';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPMTDSALE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspMtdSale';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPYTDSALE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspYtdSale';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLTDSALE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLtdSale';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLASTSALEDATE)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLastSaleDate';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPMTDCOMMEARN)) {
            $modifiedColumns[':p' . $index++]  = 'ArspMtdCommEarn';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPYTDCOMMEARN)) {
            $modifiedColumns[':p' . $index++]  = 'ArspYtdCommEarn';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLTDCOMMEARN)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLtdCommEarn';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPMTDCOMMPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArspMtdCommPaid';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPYTDCOMMPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArspYtdCommPaid';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLTDCOMMPAID)) {
            $modifiedColumns[':p' . $index++]  = 'ArspLtdCommPaid';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO AR_SALEPER3 (%s) VALUES (%s)',
    ...
    {
        $pos = ArSaleper3TableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['ArSaleper3'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArSaleper3'][$this->hashCode()] = true;
        $keys = ArSaleper3TableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getArspsaleper3(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setArspsaleper3($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPSALEPER3)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPSALEPER3, $this->arspsaleper3);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPNAME)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPNAME, $this->arspname);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPMTDSALE)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPMTDSALE, $this->arspmtdsale);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPYTDSALE)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPYTDSALE, $this->arspytdsale);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLTDSALE)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPLTDSALE, $this->arspltdsale);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLASTSALEDATE)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPLASTSALEDATE, $this->arsplastsaledate);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPMTDCOMMEARN)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPMTDCOMMEARN, $this->arspmtdcommearn);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPYTDCOMMEARN)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPYTDCOMMEARN, $this->arspytdcommearn);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLTDCOMMEARN)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPLTDCOMMEARN, $this->arspltdcommearn);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPMTDCOMMPAID)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPMTDCOMMPAID, $this->arspmtdcommpaid);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPYTDCOMMPAID)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPYTDCOMMPAID, $this->arspytdcommpaid);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_ARSPLTDCOMMPAID)) {
            $criteria->add(ArSaleper3TableMap::COL_ARSPLTDCOMMPAID, $this->arspltdcommpaid);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_DATEUPDTD)) {
            $criteria->add(ArSaleper3TableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_TIMEUPDTD)) {
            $criteria->add(ArSaleper3TableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(ArSaleper3TableMap::COL_DUMMY)) {
            $criteria->add(ArSaleper3TableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildArSaleper3Query::create();
        $criteria->add(ArSaleper3TableMap::COL_ARSPSALEPER3, $this->arspsaleper3);
    ...
    {
        $validPk = null !== $this->getArspsaleper3();
    ...
    /**
     * Generic method to set the primary key (arspsaleper3 column).
     *
    ...
    {
        return null === $this->getArspsaleper3();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArSaleper3 (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArSaleper3 Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ArSaleper3TableMap::DEFAULT_STRING_FORMAT);
    }
