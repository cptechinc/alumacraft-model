 ...
 * @method     ChildCountryQuery orderByAbbreviation($order = Criteria::ASC) Order by the abbreviation column
 ...
 * @method     ChildCountryQuery groupByAbbreviation() Group by the abbreviation column
 ...
 * @method     ChildCountry findOneByAbbreviation(string $abbreviation) Return the first ChildCountry filtered by the abbreviation column
 * @method     ChildCountry findOneByName(string $name) Return the first ChildCountry filtered by the name column
 * @method     ChildCountry findOneByArea(string $area) Return the first ChildCountry filtered by the area column *
 ...
 * @method     ChildCountry requireOneByAbbreviation(string $abbreviation) Return the first ChildCountry filtered by the abbreviation column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCountry requireOneByArea(string $area) Return the first ChildCountry filtered by the area column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildCountry[]|ObjectCollection findByAbbreviation(string $abbreviation) Return ChildCountry objects filtered by the abbreviation column
 * @method     ChildCountry[]|ObjectCollection findByName(string $name) Return ChildCountry objects filtered by the name column
 * @method     ChildCountry[]|ObjectCollection findByArea(string $area) Return ChildCountry objects filtered by the area column
...
abstract class CountryQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, abbreviation, name, area FROM country WHERE id = :p0';
        try {
    ...
    public function filterByAbbreviation($abbreviation = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CountryTableMap::COL_ABBREVIATION, $abbreviation, $comparison);
    }
