...
abstract class Country implements ActiveRecordInterface
{
    ...
    public function setAbbreviation($v)
    {
        ...
        if ($this->abbreviation !== $v) {
            $this->abbreviation = $v;
            $this->modifiedColumns[CountryTableMap::COL_ABBREVIATION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CountryTableMap::translateFieldName('Abbreviation', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CountryTableMap::translateFieldName('Area', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = CountryTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_ABBREVIATION)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setAbbreviation($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_ABBREVIATION)) {
            $criteria->add(CountryTableMap::COL_ABBREVIATION, $this->abbreviation);
        }
        if ($this->isColumnModified(CountryTableMap::COL_NAME)) {
