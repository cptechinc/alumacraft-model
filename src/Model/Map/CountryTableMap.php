...
class CountryTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'country.id';

    /**
     * the column name for the abbreviation field
     */
    const COL_ABBREVIATION = 'country.abbreviation';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Abbreviation', 'Name', 'Area', ),
        self::TYPE_CAMELNAME     => array('id', 'abbreviation', 'name', 'area', ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID, CountryTableMap::COL_ABBREVIATION, CountryTableMap::COL_NAME, CountryTableMap::COL_AREA, ),
        self::TYPE_FIELDNAME     => array('id', 'abbreviation', 'name', 'area', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Abbreviation' => 1, 'Name' => 2, 'Area' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'abbreviation' => 1, 'name' => 2, 'area' => 3, ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID => 0, CountryTableMap::COL_ABBREVIATION => 1, CountryTableMap::COL_NAME => 2, CountryTableMap::COL_AREA => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'abbreviation' => 1, 'name' => 2, 'area' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('abbreviation', 'Abbreviation', 'VARCHAR', false, 3, null);
        $this->addColumn('name', 'Name', 'VARCHAR', false, 65, null);
        $this->addColumn('area', 'Area', 'VARCHAR', false, 45, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CountryTableMap::COL_ABBREVIATION);
