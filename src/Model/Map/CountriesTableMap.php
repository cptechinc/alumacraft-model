...
class CountriesTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Code', 'Name', 'Continent', ),
        self::TYPE_CAMELNAME     => array('code', 'name', 'continent', ),
        self::TYPE_COLNAME       => array(CountriesTableMap::COL_CODE, CountriesTableMap::COL_NAME, CountriesTableMap::COL_CONTINENT, ),
        self::TYPE_FIELDNAME     => array('code', 'name', 'continent', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Code' => 0, 'Name' => 1, 'Continent' => 2, ),
        self::TYPE_CAMELNAME     => array('code' => 0, 'name' => 1, 'continent' => 2, ),
        self::TYPE_COLNAME       => array(CountriesTableMap::COL_CODE => 0, CountriesTableMap::COL_NAME => 1, CountriesTableMap::COL_CONTINENT => 2, ),
        self::TYPE_FIELDNAME     => array('code' => 0, 'name' => 1, 'continent' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('name', 'Name', 'VARCHAR', false, 70, null);
        $this->addColumn('continent', 'Continent', 'VARCHAR', false, 52, null);
    } // initialize()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CountriesTableMap::COL_CODE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CountriesTableMap::COL_CODE, (array) $values, Criteria::IN);
        }
